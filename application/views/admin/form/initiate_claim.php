...
$policy_no1 = base64_decode($policy_no); 
$base_p = rtrim($policy_no1, '=');
$claim_id = "JSPS" .$policy_no1. mt_rand();
 $company_name = $this->Form_model->list_common_where3('form','policy_no',$policy_no1);
 $com_name = $company_name[0]['company_name'];
 $company_name1 = $this->Form_model->list_common_where3('company','id',$com_name);
 $com_name1 = $company_name1[0]['name'];
?>
<!-- Begin page -->
...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">INITIATE CLAIMS</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php base_url() ?>Dashboard">Dashboards</a></li>
                                <li class="breadcrumb-item active">Initiate Claims Listing</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Initiate Claims list of <u style="color:red;"> <?=$policy_no1?> </u> Policy Number</h4>
                        </div><!-- end card header -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST" id="initiate_new_claim" enctype="multipart/form-data">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-12 ">
                                                   ...
                                                   <div class="row">
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                ...
                                                                <input type="text" class="form-control" name="policy_number"
                                                                    id="policy_number" value="<?=$policy_no1?>"
                                                                    placeholder="Enter Policy" readonly>
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                ...
                                                                <input type="text" class="form-control" name="patient_name"
                                                                    id="patient_name" placeholder="Enter Patient Name">
                                                            </div>
                                                           <div class="patient_nameerror" id="patient_nameError"></div>
                                                        </div>
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                <label for="exampleInputno" class="form-label">Company Name
                                                                    <span class="setredcolor"></span></label>
                                                                <input type="text" class=" form-control" name="company_name" id="company_name" value="<?=$com_name1;?>" readonly>
                                                        ...
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                <label for="firstName" class="form-label">Claim Intimation No.<span class="setredcolor">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    name="claim_intimation_no" id="claim_intimation_no"
                                                                    placeholder="Enter Claim Initiation No." onkeyup="validateCode();" onkeydown="validateCode()">
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                <label for="lastName" class="form-label">Reason for
                                                                    Admit</label>
                                                                <input type="text" class="form-control" name="reason_admit"
                                                                    id="reason_admit" placeholder="Enter Reason for admit">
                                                            </div>
                                                ...
                                                <div class="col-md-12 ">
                                                    <div class="row">-->
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                ...
                                                                <input type="text" class="form-control" name="health_card"
                                                                    id="health_card" placeholder="Enter Health Card Details">
                                                            </div>
                                                            <div class="error" id="descriptionError"></div>
                                                        </div>
                                                        <div class="col-md-2 setcalc mt-3">
                                                            <div>
                                                                ...
                                                                <input type="date" class="form-control" name="admission_date"
                                                                    id="admission_date" placeholder="Enter Admission Date">
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc mt-3">
                                                            <div>
                                                                <label for="lastName" class="form-label">Hospital type</label>
                                                                <select class="form-control form-select" name="is_network"
                                                                    id="is_network">
                                                        ...
                                                        <div class="col-md-2 setcalc mt-3">
                                                            <div>
                                                                ...
                                                                <select class="form-control form-select" name="claim_type"
                                                                    id="claim_type" onchange="hide_pre(this.value);">
                                                                    <option value="">Select </option>
                                                        ...
                                                        <div class="col-md-2 setcalc mt-3">
                                                            <div>
                                                                ...
                                                                <select class="form-control form-select" name="claim_for"
                                                                    id="claim_for">
                                                                    <option value="">Select</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                ...
                                                                <select class="form-control form-select" name="pre_auth_status"
                                                                    id="pre_auth_status" onchange="show_denied(this.value);">
                                                                    <option value="">Select </option>
                                                        ...
                                                        <div class="col-md-2 setcalc" id="pre_amount">
                                                            <div>
                                                                ...
                                                                <input type="number" class="form-control" name="pre_auth_amt"
                                                                    id="pre_auth_amt" placeholder="Enter Pre Auth Amount">
                                                            </div>
                                                            <div class="error" id="descriptionError"></div>
                                                        </div>
                                                    </div>
                                                </div><hr class="hidepreauth">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 setcalc">
                                                            <div>
                                                                ...
                                                                <select class="form-control form-select" name="claim_status"
                                                                    id="claim_status" onchange="show_claim(this.value);">
                                                                    <option value="">Select </option>
                                                                    <option value="Rejected">Rejected</option>
                                                                    <option value="Approved">Approved</option>
                                                        ...
                                                        <div class="col-md-2 setcalc" id="hide_amount">
                                                            <div>
                                                                ...
                                                                <input type="number" class="form-control" name="total_bill_amt"
                                                                    id="total_bill_amt" placeholder="Enter Total Bill Amount">
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc" id="hide_totalamount">
                                                            <div>
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    name="total_approve_amt" id="total_approve_amt"
                                                                    placeholder="Enter Total Approve Amount">
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc" id="hospital">
                                                            <div>
                                                                <label for="lastName" class="form-label">Hospital
                                                                    Discount</label>
                                                                <input type="number" class="form-control"
                                                                    name="hospital_discount" id="hospital_discount"
                                                                    placeholder="Enter Hospital Discount">
                                                            </div>
                                                             <div class="hospital_discounterror" id="hospital_discountError"></div>
                                                        </div>
                                                        <!--<div class="col-md-2 setcalc" id="deduct_amount_detail">
                                                            <div>
                                                                <label for="lastName" class="form-label">Deduction Amount
                                                                    Details</label>
                                                                <input type="text" class="form-control" name="deduction_amt_details"
                                                                    id="deduction_amt_details"
                                                                    placeholder="Enter Deduction Amount Details">
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc" id="paid_date">
                                                            <div>
                                                                ...
                                                                <input type="date" class="form-control" name="paid_on"
                                                                    id="paid_on" placeholder="Enter Disuction Amount Details">
                                                            </div>
                                                            <div class="paid_onerror" id="paid_onError"></div>
                                                        </div>
                                                        <div class="col-md-2 setcalc " id="final_status_1" >
                                                            <div>
                                                                <label for="lastName" class="form-label">Final Status</label>
                                                                <select class="form-control form-select" name="final_status"
                                                                    id="final_status">
                                                                    <option value="">Select</option>
                                                        ...
                                                        <div class="col-md-2 setcalc mt-3" id="deduct_amount">
                                                            <div>
                                                                <label for="lastName" class="form-label">Deduction
                                                                    Amount</label>
                                                                <input type="number" class="form-control" name="deduction_amt"
                                                                    id="deduction_amt" placeholder="Enter Deduction Amount">
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 setcalc mt-3" id="deduct_detail">
                                                            <div>
                                                                <label for="lastName" class="form-label">Deduction
                                                                    Details</label>
                                                                <textarea type="text" class="form-control" name="deduction_amt_details"
                                                                    id="deduction_amt_details" placeholder="Enter Deduction Details"></textarea>
                                                            </div>
            ...
            <input type="hidden" name="module_short_name" id="module_short_name"
                                                            value="claims">
                                                            <!--<div class="md-3">
                                                                <div class="row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-md-8 mb-3" style='display:flex'>
                                                                        ...
                                                                        <input type="file" class="form-control btn btn-primary" aria-describedby="emailHelp"
                                                                            name="doc_image[]" id="doc_image" style="display:none;">&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="col-md-12" style="display:flex;">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <h5 class="seth5"><b>
                                                                                <a
                                                                                    href="<?=base_url()?>claims/claim_details/<?=$row['claim_intimation_no'];?>">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <p class="setpara mb-1" name="subject">SUBJECT</p>
                                                                        <h5 class="seth5"><b>
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div class="d-flex gap-2 mt-1">
                                                                        ...
                                                                        <a class="btn btn-sm "><i
                                                                                ...
                                                                                onclick="changestatus(<?=$row['id'];?>,'Document Required')"
                                                                        ...
                                                                        <a class="btn btn-sm "><i
                                                                                ...
                                                                                onclick="changestatus(<?=$row['id'];?>,'Partially Passed')"
                                                                        ...
                                                                        <a class="btn btn-sm "><i
                                                                                ...
                                                                                data-placement="bottom"
                                                                                title="Claim Passed"
                                                                                onclick="changestatus(<?=$row['id'];?>,'Claim Passed')"
                                                                                style="font-size: 15px; color:green;"></i></a>
                                                                        <a class="btn btn-sm "><i class="ri-phone-line"
                                                                                data-toggle="tooltip"
                                                                                data-placement="bottom"
                                                                                title="Add Call Reminder"
                ...
                <form method="POST" id="add_call_reminder">
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-4">
                            ...
                            <input type="datetime-local" class="form-control mb-1" name="reminder_date"
                                id="reminder_date" aria-describedby="emailHelp">


                        </div>
                        <div class="col-xxl-4">
                            <label for="exampleInputEmail1" class="form-label">Reminder Remark </label>
                            <textarea type="text" class="form-control mb-1" name="reminder_remark" id="reminder_remark"
                        ...
                        <div class="col-lg-12 submit_form">
                            <div class="hstack gap-2 justify-content-end">
                                <input type="submit" class="btn btn-primary" value="Submit">
                            </div>
                        </div>
    ...
    $(document).on('submit', '#initiate_new_claim', function (ev) {
      ...
      var patientname = $('#patient_name').val();
        ...
        var remarks = $('#remarks').val();
              if (patientname == '') {
            $(".patient_nameerror").html('Enter Required Field');
            $('.patient_nameerror').css('color', 'red');
            error = true;
        ...
        if (claim_type == '') {
            $(".claim_typeerror").html('Enter Required Field');
        ...
        if (claim_status == '') {
            $(".claim_statuserror").html('Enter Required Field');
        ...
        if (final_status == '') {
            $(".final_statuserror").html('Enter Required Field');
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (dataResult.done == '1') {
                        ...
                        setTimeout(function () {
                            window.location.href = '<?= base_url() ?>claims/view_claims/'+ '<?= $this->uri->segment(2) ?>';
                        }, 1000);
...
<script>
    function add() {
        ...
        var new_input = "<div class='row'  id='new_" + new_chq_no + "' style='display:flex;margin-bottom: 1rem;width:98%;'> <div class='col-md-6'> <select class='form-control form-select' id='doc_label' name='doc_label[]'> <option value='' selected>Select</option><option value='Approval'>Approval</option<option value='Re Consideration'>Re Consideration</option><option value='Rejection Latter'>Rejection Latter</option></select></div><div class='col-xxl-5'><label for='doc_image' class='uploaddata' style='background-color: #54b2e5;padding: 4px 14px;border-radius: 8px;margin-bottom:0px;'>Upload</label><input type='file' class='form-control mb-3' aria-describedby='emailHelp' name='doc_image[]' style='display:none;'></div>";
...
<script>
  ...
  function validateCode() {
    var TCode = document.getElementById("claim_intimation_no").value;
    ...
    for (var i = 0; i < TCode.length; i++) {
        ...
        if ((cc > 47 && cc < 58) || (cc > 64 && cc < 91) || (cc > 96 && cc < 123)) {
          $('#claim_init_error').html('');
            ...
            $('#claim_init_error').html('Space are not allowed');
          	$('.error').css('color','red');
            return false;
        }
    }
