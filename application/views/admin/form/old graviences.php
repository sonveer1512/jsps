                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
						 ...
						 <div class="modal fade" id="add_new_initiate" tabindex="-1" aria-labelledby="add_new_initiate" aria-modal="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">

                                        <h5 class="modal-title" id="exampleModalgridLabel">Generate New Query for <?=$policy_no;?></h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST" id="initiate_new_claim">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div>
                                                        <label for="firstName" class="form-label">Cust ID</label>
                                                        <input type="text" class="form-control" name="cust_id" id="cust_id" value="" placeholder="Enter Customer ID">
                                                    </div>
                                                    <div class="error" id="custidError"></div>
                                                </div>

                                                <div class="col-md-6">
                                                    <div>
                                                        <label for="firstName" class="form-label">Company Name</label>
                                                        <select name="company_name" id="company_name" class="form-control form-select form-select">
                                                    ...
                                                    <div class="error" id="com_nameError"></div>
                                                </div>
                                              
                                              	<div class="col-xxl-12">
                                                    <div>
                                                        <label for="lastName" class="form-label">Nature</label>
                                                      <select class="form-control form-select" name="cus_nature" id="cus_nature" onchange="show_module_list(this.value);">
                                                        <option selected>Select Nature</option>
                                                        <option value="from_customer">From Customer</option>
                                                        <option value="from_module">From Module</option>
                                                      </select>
                                                    </div>
                                                    <div class="error" id="descriptionError"></div>
                                                </div>
                                              <div class="col-xxl-12" id="sel_module">
                                                    <div>
                                                        <label for="lastName" class="form-label">Select Module</label>
                                                      <select class="form-control form-select" name="module_nature" id="module_nature">
                                                ...
                                                <div class="col-xxl-12">
                                                    <div>
                                                        ...
                                                        <textarea type="text" class="form-control" name="subject" id="subject" placeholder="Enter Subject"></textarea>
                                                    </div>
                                                ...
                                                <div class="col-xxl-12">
                                                    <div>
                                                        <label for="lastName" class="form-label">Query Description</label>
