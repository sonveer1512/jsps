                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Work Allotment</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                                        <li class="breadcrumb-item active">Work Allotment</li>
                                    </ol>
                                </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Work Allotment</h4>
                                                ...
                                                <table class="table align-middle table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><textarea>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. </textarea></td>
                                                           <td>07 Oct, 2021</td>
                                                            <td>
...
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. </textarea></td>
 ...
 <option selected>Done</option>
  ...
  <option value="1">Disable</option>
                                                            ...
                                                            <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalgrid"><i class="ri-edit-box-line"  style="color: white;"></i></button></td>
                                                             <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModalgrid"><i class="ri-delete-bin-line"  style="color: white;"></i></button></td>
                                                        </tr>
                                                       <tr>
                                                            <td>
                                                                <div class="form-check">
...
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. </textarea></td>
 ...
 <option selected>Done</option>
  ...
  <option value="1">Disable</option>
                                                             ...
                                                             <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editsubadmin"><i class="ri-edit-box-line"  style="color: white;"></i></button></td>
                                                             <td><button type="button" class="btn btn-danger"><i class="ri-delete-bin-line"  style="color: white;"></i></button></td>
                                                        </tr>
                                                       <tr>
                                                            <td>
                                                                <div class="form-check">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalgridLabel">Edit Caller Admin</h5>
