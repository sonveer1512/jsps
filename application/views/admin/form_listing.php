            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <!-- <input type="radio" class="btn-check" name="options-outlined" value="fresh_operation" id="fresh_operation" onClick="freshpolicy();">
                        ...
                        <input type="hidden" id="module_short_name" value="<?= $model_short_name; ?>">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row count_1" style="margin-bottom: -15px;">
                                                                <div class="col-md-12 mb-1 d-flex" style="align-items: center;">
                                                                    ...
                                                                    <div class="col-md-1 flex-fill" style="margin-top: -10px;margin-left: -40px;">
                                                                        <div class="d-flex">
                                                                            <a class="btn  " class="flex-fill" data-toggle="tooltip" target="_blank" title="Edit" href="<?= base_url(); ?>form_listing/subadminedit/<?= $model_short_name ?>/<?php echo $row->id; ?>"><i class="ri-edit-2-line" style=" font-size:18px;"></i></a>
                                                ...
                                                <ul class="pagination pagination-separated pagination-sm justify-content-center justify-content-sm-start mb-0">
                                                    ...
                                                    <?php for ($i = 0; $i < ($count / 100); $i++) { ?>
                                                        <li class="page-item <?php if (($uri == '') && ($i + 1 == 1)) {
                                                            ...
                                                            <a href="<?= base_url() ?>form_listing/<?= $model_short_name; ?>/<?= $i + 1 ?>" class="page-link" style="<?php if ($uri == '') {
                                                                                                                                                                            if ($i + 1 == 1) {
                                                    ...
                                                    <?php if ($i > $uri) { ?>
                                                        <li class="page-item">
                                                            <a href="<?= base_url() ?>form_listing/<?= $model_short_name; ?>/<?= $uri + 1 ?>" class="page-link">→</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
    ...
    function searchdata() {
        ...
        $.ajax({
            ...
            data: {
                ...
                startdate: startdate,
                enddate: enddate,
                fresh_operation: fresh_operation,
