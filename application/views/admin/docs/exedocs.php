                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Exhibitors Documents</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                                        <li class="breadcrumb-item active">Exhibitors Documents</li>
                                    </ol>
                                </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Exhibitors Documents</h4>
            ...
            <div class="modal-body">
                <form action="javascript:void(0);">
                    <div class="row g-3">
                         <div class="col-xxl-6">
                            <div>
                                <label for="firstName" class="form-label">Select Exhibitors</label>
                                <select name="" class="form-control" class="form-select">
                                    <option value="1">Exhibitors Name One</option>
                                     <option value="2">Exhibitors Name Two</option>
                                      <option value="3">Exhibitors Name Three</option>
                                       <option value="4">Exhibitors Name Four</option>
                                </select>
