                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Sub Admin Documents</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                                        <li class="breadcrumb-item active">Sub Admin Documents</li>
                                    </ol>
                                </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Sub Admin Documents</h4>

                                        <div class="flex-shrink-0">     <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#exampleModalgrid">Add New Documents</button>  <button type="button" class="btn btn-primary waves-effect waves-light" id="exporttable">Export</button>                                     
            ...
            <div class="modal-body">
                <form action="javascript:void(0);">
                    <div class="row g-3">
                         <div class="col-xxl-6">
                            <div>
                                <label for="firstName" class="form-label">Select Subadmin</label>
                                <select name="" class="form-control" class="form-select">
                                    <option value="1">Subadmin Name One</option>
                                     <option value="2">Subadmin Name Two</option>
                                      <option value="3">Subadmin Name Three</option>
                                       <option value="4">Subadmin Name Four</option>
                                </select>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <div class="table-responsive table-card">
                                                <table  
                                                        class="table table-borderless table-centered align-middle table-nowrap mb-0"  id="example">
            ...
            <div class="modal-body">
                <form action="javascript:void(0);">
                    <div class="row g-3">
                         <div class="col-xxl-6">
                            <div>
                                <label for="firstName" class="form-label">Select Sub Admin</label>
                                <select name="" class="form-control" class="form-select" disabled>
                                    <option value="1">Sub Admin Name One</option>
                                     <option value="2">Sub Admin Name Two</option>
                                      <option value="3">Sub Admin Name Three</option>
                                       <option value="4">Sub Admin Name Four</option>
                                </select>
