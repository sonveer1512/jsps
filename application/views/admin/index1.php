...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | Axepert - Admin & Dashboard</title>
...
.page-title-box {
    ...
    margin: -33px -1.5rem 1.5rem -1.5rem;
    }
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="subadmin.html" class="nav-link" data-key="t-calendar"> Sub Admin </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="departmentadmin.html" class="nav-link" data-key="t-chat"> Department Admin </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarTickets">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="caller.html" class="nav-link" data-key="t-list-view">
                                                        Callers </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="marketing.html" class="nav-link"
                                                        data-key="t-ticket-details"> Marketing </a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a href="designing.html" class="nav-link"
                           ...
                           <li class="nav-item">
                            <a class="nav-link menu-link" href="exhibitors.html">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="docs">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="empdocs.html" class="nav-link" data-key="t-calendar"> Employee Documents </a>
                                    </li>
                                     <li class="nav-item">
                                        <a href="exdocs.html" class="nav-link" data-key="t-calendar">Exhibitors documents </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="subadmindocs.html" class="nav-link" data-key="t-chat">Subadmin Documents </a>
                                    </li>
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="report">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="empdocs.html" class="nav-link" data-key="t-calendar"> Clients </a>
                                    </li>
                                     <li class="nav-item">
                                        <a href="exdocs.html" class="nav-link" data-key="t-calendar">Events </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="subadmindocs.html" class="nav-link" data-key="t-chat">Check Records / Updates </a>
                                    </li>
                                     <li class="nav-item">
                                        <a href="subadmindocs.html" class="nav-link" data-key="t-chat">Payments</a>
                                    </li>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="#" class="text-decoration-underline">View All Employee</a>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="#" class="text-decoration-underline">View All Subadmin</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                                class="counter-value" data-target="100">0</span>
                                                        </h4>
                                                        <a href="#" class="text-decoration-underline">See All Department</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="#" class="text-decoration-underline">See Payment History</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card card-height-100">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Check the Expense sheet</h4>
                                            ...
                                            <div class="card-body">
                                               ...
                                               <div class="btn-group">
    <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Choose Filter</button>
...
<!-- /btn-group -->
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Events Details</h4>
                                                <div class="flex-shrink-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="fs-14 my-1"><a
                                                                                    ...
                                                                                    class="text-reset">Indigo Event Planning</a></h5>
                                                                            
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <h5 class="fs-14 my-1 fw-normal">24 Apr 2021</h5>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span class="text-muted">Avl</span>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                                    ...
                                                                                    class="text-reset">Budget Planning</a>
                                                                            </h5>
                                                                            <span class="text-muted">Budget Planning</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                                    href="apps-ecommerce-seller-details.html"
                                                                                    class="text-reset">Budget Planning</a></h5>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">Event Communication</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">3470</p>
                                                                    <span class="text-muted">Stock</span>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                                    href="apps-ecommerce-seller-details.html"
                                                                                    class="text-reset">Speaker Management</a></h5>
                                                                            <span class="text-muted">James Bowen</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span class="text-muted">Speaker Management</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">5488</p>
                                                                    <span class="text-muted">Stock</span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">Submission Systems</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">4100</p>
                                                                    <span class="text-muted">Stock</span>
                                            ...
                                            <div class="card-header align-items-center d-flex">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <button type="button" class="btn btn-soft-info btn-sm">
                                                        <i class="ri-file-list-3-line align-middle"></i> Export List
                                                    </button>
                                                </div>
                                            </div><!-- end card header -->
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="text-success">+9112345678</span>
                                                                </td>
