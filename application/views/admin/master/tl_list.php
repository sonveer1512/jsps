        ...
        <div class="container-fluid">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST" id="addteamleader">
                                            <div class="row g-3">
                                                <div class="col-xxl-6">
                                                    <div>
                                                        <label for="firstName" class="form-label">Manager</label>
                                                ...
                                                <table id="fixed-header" class="table table-bordered dt-responsive nowrap table-striped align-middle dataTable no-footer dtr-inline" style="width: 100%;" aria-describedby="fixed-header_info">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="fixed-header" rowspan="1" colspan="1" style="width: 538.4px;" aria-label="ID: activate to sort column ascending">Manager</th>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <?php if ($this->rbac->hasPrivilege('team_leader', 'can_edit')) { ?>
                                                                        <td>
                                                                            ...
                                                                            <i class="ri-edit-box-line editmodel" style="color: blue;" class="" data-bs-toggle="modal" onclick="open_modal(<?php echo $row['id']; ?>)" data-bs-target="#editsubadmin" data-id="<?php echo $row['id']; ?>"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="modal fade" id="editsubadmin" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalgridLabel">Edit Team Leader</h5>
