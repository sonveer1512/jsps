                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index-2.html" class="d-inline-block auth-logo">
                                    <img src="<?= base_url() ?>/assets/logo.png" alt="" height="40">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Axepert Exhibits Private Limited </p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>
                                ...
                                </script> Crafted with <i class="mdi mdi-heart text-danger"></i> by Axepert Exhibits Pvt. Ltd.</p>
                        </div>
                    </div>
                </div>
            </div>
